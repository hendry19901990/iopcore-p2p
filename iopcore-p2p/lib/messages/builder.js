...
function builder(options) {
  ...
  if (!options.network) {
    options.network = iopcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || iopcore.Block;
  options.BlockHeader = options.BlockHeader || iopcore.BlockHeader;
  options.Transaction = options.Transaction || iopcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || iopcore.MerkleBlock;
